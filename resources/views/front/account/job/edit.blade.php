                    ...
                    <div class="card border-0 shadow mb-4 ">
                        <div class="card-body card-form p-4">
                            ...
                            <div class="mb-4">
                                ...
                                <textarea class="textarea" name="description" id="description" cols="93" rows="5" placeholder="Description">{{ $job->description }}</textarea>
                                <p></p>
                            </div>
                            <div class="mb-4">
                                <label for="" class="mb-2">Benefits</label>
                                <textarea class="textarea" name="benefits" id="benefits" cols="93" rows="5" placeholder="Benefits">{{ $job->benefits }}</textarea>
                            </div>
                            <div class="mb-4">
                                <label for="" class="mb-2">Responsibility</label>
                                <textarea class="textarea" name="responsibility" id="responsibility" cols="93" rows="5" placeholder="Responsibility">{{ $job->responsibility }}</textarea>
                            </div>
                            <div class="mb-4">
                                <label for="" class="mb-2">Qualifications</label>
                                <textarea class="textarea" name="qualifications" id="qualifications" cols="93" rows="5" placeholder="Qualifications">{{ $job->qualifications }}</textarea>
                            </div>
